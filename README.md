...
# Conclusion
In conclusion, these Python generated forecast results seems to be in line with the official forecast of 100,000 to 200,000 possible deaths. Take this all with a grain of salt as I have no experience with epidemiology or any medical field. It does appear that the official death toll forecast was based on a forecast using linear regression on the death trend. Hoping the numbers will be much less. Regardless of what this forecast shows, I am more optimistic with a range of 50,000 - 100,000 possible deaths. However, the final number of deaths may be less if doctors and nurses don't fall ill and hospitals are not overwhelmed. Any loss of life is tragic and hope for the best. Stay safe and feel free to use and distribute this code however you wish. 
